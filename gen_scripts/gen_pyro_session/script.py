...
def main():
    ...
    try:
        with Client(
            ...
            api_hash=api_hash,
            phone_number=phone,
            app_version="@CineFlow_Update User Session",
            device_model="@CineFlow_Update Bot V3",
            system_version="@CineFlow_Update WzPyro Server",
        ) as user:
            ...
            user.send_message(
                ...
                "**Generated by @CineFlow_Update Manual Script.**",
            )
