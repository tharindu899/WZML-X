...
DEFAULT_DESP = {
    ...
    "GD_DESP": "Description for Google Drive uploads. Default: Uploaded with CineFlow Bot.",
    ...
    "YT_DESP": "Description for YouTube uploads. Default: Uploaded with CineFlow bot.",
